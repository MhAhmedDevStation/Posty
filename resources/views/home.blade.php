...
@section('content')
                ...
                <div class="col-xl-12 col-lg-12">
                    <div class="hero-content">
                        <h4
                            ...
                            data-wow-delay=".5s"
                        >Learn from the comfort of your own home.</h4>
                        <h1
                            class="wow fadeInLeft"
                            data-wow-delay=".6s"
                        >Get 5000+ free choose the right education</h1>
                        <p
                            class="wow fadeInLeft"
                            data-wow-delay=".7s"
                        >Improve your skill! We provide high-quality online courses and are constantly upgrading our
                            knowledge.</p>
                        <div class="hero-btn mt-30">
                            <a
                                href=""
                                class="t-btn wow fadeInUp mr-15"
                                data-wow-delay="1s"
                            >Know More</a>
                            <a
                                href=""
                                class="t-btn wow fadeInUp"
                                data-wow-delay="1.3s"
                            >View All Course</a>
                        </div>
                    </div>
            ...
            <div class="container">
                <div class="row">
                    <div class="col-xl-4 col-lg-4 col-md-12">
                        <div
                            class="single-hero-features wow fadeInUp"
                            data-wow-delay=".8s"
                        >
                            <div class="single-features-icon">
                                <img
                                    src="{{ asset('images/hero/hero-features/hero-f1.svg') }}"
                                    alt=""
                                >
                            </div>
                    ...
                    <div class="col-xl-4 col-lg-4 col-md-12">
                        ...
                        >
                            <div class="single-features-icon">
                                <img
                                    src="{{ asset('images/hero/hero-features/hero-f2.svg') }}"
                                    alt=""
                                >
                            </div>
                            <div class="single-features-text">
                    ...
                    <div class="col-xl-4 col-lg-4 col-md-12">
                        ...
                        >
                            <div class="single-features-icon">
                                <img
                                    src="{{ asset('images/hero/hero-features/hero-f3.svg') }}"
                                    alt=""
                                >
                            </div>
                            <div class="single-features-text">
        ...
        <div class="container">
            ...
            <div class="row about-color">
                <div class="col-xl-4 col-lg-4">
                    <div
                        class="single-about-us mb-30 wow fadeInUp"
                        data-wow-delay=".3s"
                    >
        ...
        <div class="container">
            <div class="row align-items-center">
                <div class="col-xl-6 col-lg-6">
                    <div
                        class="section-title wow fadeInUp mb-40 text-left"
                        data-wow-delay=".4s"
                    >
                    ...
                    <div
                        class="single-job wow fadeInLeft"
                        data-wow-delay=".5s"
                    >
                        <ul>
                            <li>
                ...
                <div class="col-xl-6 col-lg-6">
                    ...
                    >
                        <img
                            src="{{ asset('images/technology/tech1.jpg') }}"
                            alt=""
                        >
                        <div class="dr-sm-img">
                            <img
                                src="{{ asset('images/technology/tech2.jpg') }}"
                                alt=""
                            >
                        </div>
        ...
        <div class="container">
            ...
            <div class="row">
                <div class="col-xl-4 col-lg-4 col-md-6">
                    <div
                        class="single-course mb-30 wow fadeInUp"
                        data-wow-delay=".3s"
                    >
                        <div class="course-img">
                            <img
                                src="{{ asset('images/course/course1.jpg') }}"
                                alt=""
                            >
                        </div>
                ...
                <div class="col-xl-4 col-lg-4 col-md-6">
                    ...
                    >
                        <div class="course-img">
                            <img
                                src="{{ asset('images/course/course2.jpg') }}"
                                alt=""
                            >
                        </div>
                        <div class="course-text">
                ...
                <div class="col-xl-4 col-lg-4 col-md-6">
                    ...
                    >
                        <div class="course-img">
                            <img
                                src="{{ asset('images/course/course3.jpg') }}"
                                alt=""
                            >
                        </div>
                        <div class="course-text">
                ...
                <div class="col-xl-4 col-lg-4 col-md-6">
                    ...
                    >
                        <div class="course-img">
                            <img
                                src="{{ asset('images/course/course4.jpg') }}"
                                alt=""
                            >
                        </div>
                        <div class="course-text">
                ...
                <div class="col-xl-4 col-lg-4 col-md-6">
                    ...
                    >
                        <div class="course-img">
                            <img
                                src="{{ asset('images/course/course5.jpg') }}"
                                alt=""
                            >
                        </div>
                        <div class="course-text">
                ...
                <div class="col-xl-4 col-lg-4 col-md-6">
                    ...
                    >
                        <div class="course-img">
                            <img
                                src="{{ asset('images/course/course6.jpg') }}"
                                alt=""
                            >
                        </div>
                        <div class="course-text">
                ...
                <div class="row">
                    <div class="col-xl-12">
                        <div
                            class="course-btn wow fadeInUp mt-20 text-center"
                            data-wow-delay="1.5s"
                        >
                            <a
                                href="#"
    ...
    <div
        class="features-video pt-110 pb-110"
        style="background-image:url({{ asset('images/video/video-1.jpg') }})"
    >
            ...
            <div class="row align-items-center">
                ...
                <div class="col-xl-5 col-lg-5 col-md-10">
                    <div class="features-video-box text-center">
                        <a
                            href="https://www.youtube.com/watch?v=t5akgsQsOSk"
                            class="features-video-icon"
        ...
        <div class="container">
            ...
            <div class="row">
                <div class="col-xl-3 col-lg-6 col-md-6">
                    <div
                        class="single-instructor mb-30 wow fadeInUp"
                        data-wow-delay=".3s"
                    >
                        <div class="single-instructor-img">
                            <img
                                src="{{ asset('images/instructor/member1.jpg') }}"
                                alt=""
                            >
                ...
                <div class="col-xl-3 col-lg-6 col-md-6">
                    ...
                    >
                        <div class="single-instructor-img">
                            <img
                                src="{{ asset('images/instructor/member2.jpg') }}"
                                alt=""
                            >
                            <div class="single-instructor-content">
                ...
                <div class="col-xl-3 col-lg-6 col-md-6">
                    ...
                    >
                        <div class="single-instructor-img">
                            <img
                                src="{{ asset('images/instructor/member3.jpg') }}"
                                alt=""
                            >
                            <div class="single-instructor-content">
                ...
                <div class="col-xl-3 col-lg-6 col-md-6">
                    ...
                    >
                        <div class="single-instructor-img">
                            <img
                                src="{{ asset('images/instructor/member4.jpg') }}"
                                alt=""
                            >
                            <div class="single-instructor-content">
    ...
    <div class="lates-article pt-110 pb-80">
        <div class="container">
            ...
            <div class="row">
                <div class="col-xl-4 col-lg-4 col-md-6">
                    <div
                        class="single-article mb-30 wow fadeInUp"
                        data-wow-delay=".3s"
                    >
                        <div class="article-img">
                            <a href="#"><img
                                    src="{{ asset('images/course/course8.jpg') }}"
                                    alt=""
                                ></a>
                        </div>
                ...
                <div class="col-xl-4 col-lg-4 col-md-6">
                    ...
                    >
                        <div class="article-img">
                            <a href="#"><img
                                    src="{{ asset('images/course/course9.jpg') }}"
                                    alt=""
                                ></a>
                        </div>
                        <div class="article-content">
                            <a
                                href="#"
                                class="article-btn"
                            ><i class="fas fa-tag"></i>learning</a>
                            <div class="article-meta">
                                <ul>
                                    <li><i class="far fa-user"></i><a href="#">Admin</a></li>
                ...
                <div class="col-xl-4 col-lg-4 col-md-6">
                    ...
                    >
                        <div class="article-img">
                            <a href="#"><img
                                    src="{{ asset('images/course/course10.jpg') }}"
                                    alt=""
                                ></a>
                        </div>
                        <div class="article-content">
                            <a
                                href="#"
                                class="article-btn"
                            ><i class="fas fa-tag"></i>Succeed</a>
                            <div class="article-meta">
                                <ul>
                                    <li><i class="far fa-user"></i><a href="#">Admin</a></li>
    ...
    <div class="site-wrap">
        <div class="our-site pt-110 pb-110">
            <div
                ...
                style="background-image:url({{ asset('images/institute/institute1.jpg') }})"
            ></div>
            <div class="container">
                <div class="row">
                    <div class="col-xl-6 col-lg-6 col-md-6">
                        <div
                            class="boxed-content wow fadeInLeft"
                            data-wow-delay=".3s"
                        >
        ...
        <div class="our-site absolute-bg-left pt-110 pb-110">
            <div
                class="section-absolute-bg"
                style="background-image:url({{ asset('images/institute/institute2.jpg') }})"
            ></div>
            <div class="container">
                <div class="row">
                    <div class="col-xl-6 offset-xl-6 col-lg-6 offset-lg-6 col-md-6 offset-md-6">
                        <div
                            class="boxed-content wow fadeInRight"
                            data-wow-delay=".6s"
                        >
    ...
    <div class="upcoming-event pt-110 pb-80">
        <div class="container">
            <div class="row">
                <div class="col-xl-12">
                    <div
                        class="event-box mb-30 wow fadeInLeft"
                        data-wow-delay=".3s"
                    >
                    ...
                    <div
                        class="event-box mb-30 wow fadeInRight"
                        data-wow-delay=".5s"
                    >
                        <div class="event-content">
                            <div class="date-event d-none d-sm-block">
        ...
        <div class="container">
            <div class="row align-items-center">
                <div class="col-xl-6 col-lg-6 mb-30">
                    <div
                        class="solution-innner wow fadeInLeft"
                        data-wow-delay=".5s"
                    >
                        ...
                        <img
                            src="{{ asset('images/solution/solution.png') }}"
                            alt=""
                            class="solution-img"
                        >
                    </div>
                ...
                <div class="col-xl-6 col-lg-6">
                    <div
                        class="solution-text wow fadeInRight"
                        data-wow-delay=".7s"
                    >
                ...
                <div class="col-xl-12 text-center">
                    <div class="brand-active">
                        <div class="single-brand">
                            <a href="#"><img
                                    src="{{ asset('images/brand/brand-icon-01.png') }}"
                                    alt=""
                                ></a>
                        </div>
                        <div class="single-brand">
                            <a href="#"><img
                                    src="{{ asset('images/brand/brand-icon-02.png') }}"
                                    alt=""
                                ></a>
                        </div>
                        <div class="single-brand">
                            <a href="#"><img
                                    src="{{ asset('images/brand/brand-icon-03.png') }}"
                                    alt=""
                                ></a>
                        </div>
                        <div class="single-brand">
                            <a href="#"><img
                                    src="{{ asset('images/brand/brand-icon-04.png') }}"
                                    alt=""
                                ></a>
                        </div>
                        <div class="single-brand">
                            <a href="#"><img
                                    src="{{ asset('images/brand/brand-icon-05.png') }}"
                                    alt=""
                                ></a>
                        </div>
                        <div class="single-brand">
                            <a href="#"><img
                                    src="{{ asset('images/brand/brand-icon-06.png') }}"
                                    alt=""
                                ></a>
                        </div>
                        <div class="single-brand">
                            <a href="#"><img
                                    src="{{ asset('images/brand/brand-icon-07.png') }}"
                                    alt=""
                                ></a>
                        </div>
                        <div class="single-brand">
